								...
								>
									...
									sortedChatrooms?.map((chatroom: any) => (
										<Card
											...
											} mb-2 h-[77px] w-[90%] overflow-hidden rounded-full transition-all duration-300 ease-in-out hover:scale-[1.02] hover:bg-gradient-to-r hover:from-[#ecac21] hover:via-[#ecac21] hover:via-70% hover:to-[#997924] hover:shadow-lg`}
											style={{
												cursor: 'pointer',
												transition:
